        ...
        st.sidebar.write(f'Welcome *{name}*')
                                ...
                                if response.status_code == 200:
                                    ...
                                    if result.get('success'):
                                        ...
                                        with col1:
                                            ...
                                            st.metric(
                                                "Subtotal",
                                                f"{subtotal} {currency}".strip() if subtotal != 'N/A' else 'N/A'
                                            )
                                        ...
                                        with col2:
                                            ...
                                            st.metric(
                                                "Tax",
                                                f"{tax} {currency}".strip() if tax != 'N/A' else 'N/A'
                                            )
                                        ...
                                        with col3:
                                            ...
                                            st.metric(
                                                "Total",
                                                f"{total} {currency}".strip() if total != 'N/A' else 'N/A',
                                                delta=None
                                            )
                                        ...
                                        if items:
                                            st.caption(f"Found {len(items)} line item(s)")
            ...
            with tab2:
                ...
                if 'recent_uploads' in st.session_state and st.session_state.recent_uploads:
                    st.caption(f"Showing {len(st.session_state.recent_uploads)} recent invoice(s)")
